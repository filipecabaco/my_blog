defmodule BlogWeb.Components.ReadTag do
  ...
  @impl true
  def update(%{title: title, read_tag_id: read_tag_id, id: id}, socket) do
    {:ok, assign(socket, %{title: title, read_tag: Supervisor.get_state(read_tag_id), read_tag_id: read_tag_id, id: id, self_id: socket.id})}
  end
